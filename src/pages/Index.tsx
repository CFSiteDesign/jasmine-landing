    ...
    <div className="min-h-screen relative pb-20 md:pb-0">
      ...
      <nav className="fixed top-0 w-full z-50 bg-card/90 backdrop-blur-md border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex-shrink-0 flex items-center gap-3">
              ...
              <span className="text-foreground font-display font-black text-sm tracking-tight">JASMIN ROSTOCK</span>
            </div>
            <div className="hidden md:flex space-x-8 items-center font-semibold text-sm">
              ...
              <a href="#who-its-for" className="text-muted-foreground hover:text-brand-red transition-colors">Who It's For</a>
                <a href="https://buy.stripe.com/00w6oG4Ib5figGI2L0e7t2j" target="_blank" rel="noreferrer" className="bg-brand-red text-primary-foreground px-5 py-2 rounded-full hover:opacity-90 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5 duration-200">
                   Get Info
                 </a>
            </div>
          </div>
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-primary-foreground">
          ...
          <div className="flex justify-center gap-4 mb-8">
           ...
           <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="https://buy.stripe.com/00w6oG4Ib5figGI2L0e7t2j" target="_blank" rel="noreferrer" className="bg-brand-red text-primary-foreground text-lg font-bold px-8 py-4 rounded-full hover:opacity-90 transition-all shadow-xl hover:shadow-2xl transform hover:-translate-y-1 duration-200 flex items-center justify-center gap-2">
       ...
       <section className="py-24 bg-brand-red text-primary-foreground text-center px-4 relative overflow-hidden">
         ...
         <div className="relative z-10 max-w-3xl mx-auto">
           ...
           <p className="text-xl md:text-2xl font-medium mb-10 opacity-90">
            ...
            <a href="https://buy.stripe.com/00w6oG4Ib5figGI2L0e7t2j" target="_blank" rel="noreferrer" className="inline-block bg-brand-black text-primary-foreground text-xl font-black uppercase px-10 py-5 rounded-full hover:opacity-90 transition-all shadow-2xl transform hover:scale-105 duration-200">
              Lock It In Now
            </a>
         </div>
       </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
            <div className="flex items-center gap-3">
              ...
              <span className="text-brand-red text-xl font-bold">|</span>
              <span className="text-primary-foreground font-display font-black text-sm tracking-tight">JASMIN ROSTOCK</span>
            </div>
      ...
      {/* STICKY MOBILE CTA */}
       <div className={`fixed bottom-0 left-0 w-full p-4 bg-card border-t border-border shadow-[0_-10px_20px_rgba(0,0,0,0.1)] z-50 md:hidden transition-transform duration-300 ${isScrolled ? 'translate-y-0' : 'translate-y-full'}`}>
          <a href="https://buy.stripe.com/00w6oG4Ib5figGI2L0e7t2j" target="_blank" rel="noreferrer" className="flex items-center justify-center w-full bg-brand-red text-primary-foreground font-black uppercase py-4 rounded-xl shadow-lg active:scale-95 transition-transform">
